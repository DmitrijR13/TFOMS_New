...
"select"===k.stype?"eq":d.defaultSearch;for(r=0;r<d.odata.length;r++)if(d.odata[r].oper===m){p=d.operands[m]||"";break}m="<a title='"+(null!=l.searchtitle?l.searchtitle:d.operandTitle)+"' style='padding-right: 0.5em;' soper='"+m+"' class='soptclass' colname='"+this.name+"'>"+p+"</a>"}a("td:eq(0)",s).attr("colindex",f).append(m);void 0===l.clearSearch&&(l.clearSearch=!0);l.clearSearch?(m=d.resetTitle||"Очистить фильтр",a("td:eq(2)",s).append("<a title='"+m+"' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>"+
